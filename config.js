...
const config = {
    ...
    // link to about page, set to null if you want to omit it
    info: 'https://www.geofabrik.de/projects/railway_routing/index.html',
    ...
    // Profile group mapping is not supported by OpenRailRouting Maps.
